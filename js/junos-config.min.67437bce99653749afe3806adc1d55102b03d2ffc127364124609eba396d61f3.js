document.addEventListener("DOMContentLoaded",()=>{const W=document.querySelectorAll(".tab-btn"),ne=document.querySelectorAll(".tab-content");W.forEach(e=>{e.addEventListener("click",()=>{W.forEach(e=>e.classList.remove("active")),e.classList.add("active"),ne.forEach(e=>e.style.display="none");const t=e.getAttribute("data-tab");document.getElementById(`${t}-content`).style.display="block"})});const se=[{checkbox:"interface-description-enabled",section:"description-group"},{checkbox:"ipv6-enabled",section:"ipv6-config"},{checkbox:"vlan-enabled",section:"vlan-config"},{checkbox:"firewall-filter-enabled",section:"firewall-filter-config"},{checkbox:"zones-enabled",section:"zones-config"},{checkbox:"ntp-enabled",section:"ntp-config"},{checkbox:"ntp-source-interface-enabled",section:"ntp-source-interface-group"},{checkbox:"dhcp-server-enabled",section:"dhcp-server-config"},{checkbox:"syslog-enabled",section:"syslog-config"},{checkbox:"snmp-enabled",section:"snmp-config"},{checkbox:"policy-options-enabled",section:"policy-options-config"},{checkbox:"cos-enabled",section:"cos-config"},{checkbox:"routing-policy-prefix-list-enabled",section:"routing-policy-prefix-list-group"},{checkbox:"bgp-peer-import-policy-enabled",section:"bgp-peer-import-policy"},{checkbox:"bgp-peer-export-policy-enabled",section:"bgp-peer-export-policy"}];se.forEach(e=>{const t=document.getElementById(e.checkbox+"-0");if(t){const n=document.getElementById(e.section+"-0");n&&t.addEventListener("change",()=>{n.style.display=t.checked?"block":"none"})}const n=document.getElementById(e.checkbox);if(n){const t=document.getElementById(e.section);t&&n.addEventListener("change",()=>{t.style.display=n.checked?"block":"none"})}});const E=document.getElementById("routing-protocol"),ie=document.querySelectorAll(".protocol-config");E&&E.addEventListener("change",()=>{ie.forEach(e=>{e.style.display="none"});const e=E.value;e!=="none"&&(document.getElementById(`${e}-config`).style.display="block")});const y=document.getElementById("term-protocol-0"),k=document.getElementById("port-fields-0");y&&k&&y.addEventListener("change",()=>{y.value==="tcp"||y.value==="udp"?k.style.display="block":k.style.display="none"});let t=1;const z=document.getElementById("add-interface"),g=document.getElementById("interfaces-list");if(z&&g){z.addEventListener("click",()=>{const e=document.createElement("div");e.className="interface-item",e.innerHTML=`
            ...
            `,g.appendChild(e);const n=document.getElementById(`ipv6-enabled-${t}`);n.addEventListener("change",function(){const e=document.getElementById(`ipv6-config-${t}`);e.style.display=this.checked?"block":"none"});const s=document.getElementById(`interface-description-enabled-${t}`);s.addEventListener("change",function(){const e=document.getElementById(`description-group-${t}`);e.style.display=this.checked?"block":"none"});const o=document.getElementById(`vlan-enabled-${t}`);o.addEventListener("change",function(){const e=document.getElementById(`vlan-config-${t}`);e.style.display=this.checked?"block":"none"});const i=e.querySelector(".remove-interface");i.addEventListener("click",function(){document.querySelectorAll(".interface-item").length>1?g.removeChild(e):alert("You need at least one interface.")});const a=document.getElementById(`interface-type-${t}`);a.addEventListener("change",function(){const e=document.getElementById(`custom-interface-name-${t}`);e.style.display=this.value==="custom"?"block":"none"}),updateInterfaceSelects(),t++});const e=document.querySelector(".remove-interface");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".interface-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".interface-item");g.removeChild(e)}else alert("You need at least one interface.")})}let c=1;const N=document.getElementById("add-static-route"),f=document.getElementById("static-routes-list");if(N&&f){N.addEventListener("click",()=>{const e=document.createElement("div");e.className="static-route-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,f.appendChild(e);const t=e.querySelector(".remove-route");t.addEventListener("click",function(){document.querySelectorAll(".static-route-item").length>1?f.removeChild(e):alert("You need at least one static route.")}),c++});const e=document.querySelector(".remove-route");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".static-route-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".static-route-item");f.removeChild(e)}else alert("You need at least one static route.")})}let l=1;const Y=document.getElementById("add-ospf-area"),p=document.getElementById("ospf-areas");if(Y&&p){Y.addEventListener("click",()=>{const e=document.createElement("div");e.className="ospf-area-item",e.innerHTML=`
                <div class="input-group">
...
`}c.textContent=e,document.getElementById("config-output-container").style.display="block"}let e=1;const T=document.getElementById("add-filter"),u=document.getElementById("filters-list");if(T&&u){T.addEventListener("click",()=>{const t=document.createElement("div");t.className="filter-item",t.innerHTML=`
                <div class="input-group">
            ...
            `,m.appendChild(e);const t=e.querySelector(".remove-zone");t&&t.addEventListener("click",function(){document.querySelectorAll(".zone-item").length>1?m.removeChild(e):alert("You need at least one security zone.")}),i++});const e=document.querySelector(".remove-zone");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".zone-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".zone-item");m.removeChild(e)}else alert("You need at least one security zone.")})}let o=1;const D=document.getElementById("add-policy"),O=document.getElementById("policies-list");if(D&&O){D.addEventListener("click",()=>{const e=document.createElement("div");e.className="policy-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,O.appendChild(e);const t=e.querySelector(".remove-policy");t&&t.addEventListener("click",function(){document.querySelectorAll(".policy-item").length>1?O.removeChild(e):alert("You need at least one security policy.")}),o++});const e=document.querySelector(".remove-policy");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".policy-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".policy-item");O.removeChild(e)}else alert("You need at least one security policy.")})}let r=1;const R=document.getElementById("add-prefix-list"),h=document.getElementById("prefix-lists");if(R&&h){R.addEventListener("click",()=>{const e=document.createElement("div");e.className="prefix-list-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,_.appendChild(e);const n=e.querySelector(".add-statement"),t=e.querySelector(`#policy-statements-${s}`);if(n&&t){let e=1;n.addEventListener("click",()=>{const n=document.createElement("div");n.className="policy-statement",n.innerHTML=`
                        <div class="input-group">
