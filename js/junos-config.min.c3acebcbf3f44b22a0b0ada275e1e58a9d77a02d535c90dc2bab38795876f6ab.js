document.addEventListener("DOMContentLoaded",()=>{const N=document.querySelectorAll(".tab-btn"),le=document.querySelectorAll(".tab-content");N.forEach(e=>{e.addEventListener("click",()=>{N.forEach(e=>e.classList.remove("active")),e.classList.add("active"),le.forEach(e=>e.style.display="none");const t=e.getAttribute("data-tab");document.getElementById(`${t}-content`).style.display="block"})});const ue=[{checkbox:"interface-description-enabled",section:"description-group"},{checkbox:"ipv6-enabled",section:"ipv6-config"},{checkbox:"vlan-enabled",section:"vlan-config"},{checkbox:"firewall-filter-enabled",section:"firewall-filter-config"},{checkbox:"zones-enabled",section:"zones-config"},{checkbox:"ntp-enabled",section:"ntp-config"},{checkbox:"ntp-source-interface-enabled",section:"ntp-source-interface-group"},{checkbox:"dhcp-server-enabled",section:"dhcp-server-config"},{checkbox:"syslog-enabled",section:"syslog-config"},{checkbox:"snmp-enabled",section:"snmp-config"},{checkbox:"policy-options-enabled",section:"policy-options-config"},{checkbox:"cos-enabled",section:"cos-config"},{checkbox:"routing-policy-prefix-list-enabled",section:"routing-policy-prefix-list-group"},{checkbox:"bgp-peer-import-policy-enabled",section:"bgp-peer-import-policy"},{checkbox:"bgp-peer-export-policy-enabled",section:"bgp-peer-export-policy"}];ue.forEach(e=>{const t=document.getElementById(e.checkbox+"-0");if(t){const n=document.getElementById(e.section+"-0");n&&t.addEventListener("change",()=>{n.style.display=t.checked?"block":"none"})}const n=document.getElementById(e.checkbox);if(n){const t=document.getElementById(e.section);t&&n.addEventListener("change",()=>{t.style.display=n.checked?"block":"none"})}});const x=document.getElementById("routing-protocol"),he=document.querySelectorAll(".protocol-config");x&&x.addEventListener("change",()=>{he.forEach(e=>{e.style.display="none"});const e=x.value;e!=="none"&&(document.getElementById(`${e}-config`).style.display="block")});const A=document.getElementById("static-enabled"),F=document.getElementById("ospf-enabled"),k=document.getElementById("bgp-enabled"),U=document.getElementById("static-routes-config"),X=document.getElementById("ospf-config"),J=document.getElementById("bgp-config");A&&U&&A.addEventListener("change",()=>{U.style.display=A.checked?"block":"none"}),F&&X&&F.addEventListener("change",()=>{X.style.display=F.checked?"block":"none"}),k&&J&&k.addEventListener("change",()=>{J.style.display=k.checked?"block":"none"});const m=document.getElementById("term-protocol-0"),C=document.getElementById("port-fields-0");m&&C&&m.addEventListener("change",()=>{m.value==="tcp"||m.value==="udp"?C.style.display="block":C.style.display="none"});let t=1;const V=document.getElementById("add-interface"),p=document.getElementById("interfaces-list");if(V&&p){V.addEventListener("click",()=>{const e=document.createElement("div");e.className="interface-item",e.innerHTML=`
            ...
            `,p.appendChild(e);const n=document.getElementById(`ipv6-enabled-${t}`);n.addEventListener("change",function(){const e=document.getElementById(`ipv6-config-${t}`);e.style.display=this.checked?"block":"none"});const s=document.getElementById(`interface-description-enabled-${t}`);s.addEventListener("change",function(){const e=document.getElementById(`description-group-${t}`);e.style.display=this.checked?"block":"none"});const o=document.getElementById(`vlan-enabled-${t}`);o.addEventListener("change",function(){const e=document.getElementById(`vlan-config-${t}`);e.style.display=this.checked?"block":"none"});const i=e.querySelector(".remove-interface");i.addEventListener("click",function(){document.querySelectorAll(".interface-item").length>1?p.removeChild(e):alert("You need at least one interface.")});const a=document.getElementById(`interface-type-${t}`);a.addEventListener("change",function(){const e=document.getElementById(`custom-interface-name-${t}`);e.style.display=this.value==="custom"?"block":"none"}),L(),t++});const e=document.querySelector(".remove-interface");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".interface-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".interface-item");p.removeChild(e)}else alert("You need at least one interface.")})}let c=1;const Z=document.getElementById("add-static-route"),b=document.getElementById("static-routes-list");if(Z&&b){Z.addEventListener("click",()=>{const e=document.createElement("div");e.className="static-route-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,b.appendChild(e);const t=e.querySelector(".remove-route");t.addEventListener("click",function(){document.querySelectorAll(".static-route-item").length>1?b.removeChild(e):alert("You need at least one static route.")}),c++});const e=document.querySelector(".remove-route");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".static-route-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".static-route-item");b.removeChild(e)}else alert("You need at least one static route.")})}let l=1;const q=document.getElementById("add-ospf-area"),_=document.getElementById("ospf-areas");if(q&&_){q.addEventListener("click",()=>{const e=document.createElement("div");e.className="ospf-area-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,_.appendChild(e);const t=e.querySelector(".remove-ospf-area");t.addEventListener("click",function(){document.querySelectorAll(".ospf-area-item").length>1?_.removeChild(e):alert("You need at least one OSPF area.")}),l++});const e=document.querySelector(".remove-ospf-area");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".ospf-area-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".ospf-area-item");_.removeChild(e)}else alert("You need at least one OSPF area.")})}let n=1;const W=document.getElementById("add-bgp-neighbor"),w=document.getElementById("bgp-neighbors");if(W&&w){W.addEventListener("click",()=>{const e=document.createElement("div");e.className="bgp-neighbor-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,w.appendChild(e);const t=e.querySelector(`#bgp-peer-import-policy-enabled-${n}`),o=e.querySelector(`#bgp-peer-import-policy-${n}`);t&&o&&t.addEventListener("change",()=>{o.style.display=t.checked?"block":"none"});const s=e.querySelector(`#bgp-peer-export-policy-enabled-${n}`),i=e.querySelector(`#bgp-peer-export-policy-${n}`);s&&i&&s.addEventListener("change",()=>{i.style.display=s.checked?"block":"none"});const a=e.querySelector(".remove-bgp-neighbor");a.addEventListener("click",function(){document.querySelectorAll(".bgp-neighbor-item").length>1?w.removeChild(e):alert("You need at least one BGP neighbor.")}),n++});const s=document.querySelector(".remove-bgp-neighbor");s&&s.addEventListener("click",function(){if(document.querySelectorAll(".bgp-neighbor-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".bgp-neighbor-item");w.removeChild(e)}else alert("You need at least one BGP neighbor.")});const e=document.getElementById("bgp-peer-import-policy-enabled-0"),o=document.getElementById("bgp-peer-import-policy-0");e&&o&&e.addEventListener("change",()=>{o.style.display=e.checked?"block":"none"});const t=document.getElementById("bgp-peer-export-policy-enabled-0"),i=document.getElementById("bgp-peer-export-policy-0");t&&i&&t.addEventListener("change",()=>{i.style.display=t.checked?"block":"none"})}const T=document.getElementById("generate-config"),E=document.getElementById("config-output"),B=document.getElementById("config-output-container");T&&E&&B&&T.addEventListener("click",()=>{de(),B.scrollIntoView({behavior:"smooth"})});const H=document.getElementById("reset-form");H&&H.addEventListener("click",()=>{confirm("Are you sure you want to reset the form? All your configuration will be lost.")&&window.location.reload()});const P=document.getElementById("copy-config"),M=document.getElementById("copy-tooltip");P&&E&&M&&P.addEventListener("click",()=>{me(E.textContent),M.style.display="block",setTimeout(()=>{M.style.display="none"},2e3)});function me(e){const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t)}function de(){const y=document.getElementById("config-output"),b=document.getElementById("hostname").value||"router",m=document.getElementById("domain-name").value;let e="";e+=`system {
`,e+=`    host-name ${b};
`,m&&(e+=`    domain-name ${m};
`);const g=document.getElementById("root-password").value,i=document.getElementById("use-encrypted-password").checked;g&&(i?(e+=`    root-authentication {
`,e+=`        encrypted-password "$9$XXXXXXXXXXXXXXXXXXXXXX"; # Reference only, replace with real encrypted password
`,e+=`    }
`):(e+=`    root-authentication {
`,e+=`        plain-text-password-value "${g}";
`,e+=`    }
`));const a=document.getElementById("login-user").value,r=document.getElementById("login-password").value,w=document.getElementById("user-class").value;a&&r&&(e+=`    login {
`,e+=`        user ${a} {
`,e+=`            class ${w};
`,e+=`            authentication {
...
`,e+=`        }
`,e+=`    }
`);const _=document.getElementById("system-timezone").value;e+=`    time-zone ${_};
`;const s=document.getElementById("dns-servers").value;s&&(e+=`    name-server {
`,s.split(",").forEach(t=>{const n=t.trim();n&&(e+=`        ${n};
`)}),e+=`    }
`),e+=`}

`,e+=`interfaces {
`;const j=document.querySelectorAll(".interface-item");j.forEach((t,n)=>{let s=t.querySelector(`#interface-type-${n}`).value;if(s==="custom"){const o=document.getElementById(`custom-interface-name-${n}`),e=t.querySelector(`#custom-interface-value-${n}`).value;e?s=e:(console.warn("Custom interface selected but no value provided, using a default"),s="ge-0/0/0")}const a=t.querySelector(`#unit-number-${n}`).value||"0",o=t.querySelector(`#ip-address-${n}`).value,r=t.querySelector(`#prefix-length-${n}`).value||"24";e+=`    ${s} {
...
`;const h=document.getElementById("static-enabled")&&document.getElementById("static-enabled").checked,n=document.getElementById("ospf-enabled")&&document.getElementById("ospf-enabled").checked,t=document.getElementById("bgp-enabled")&&document.getElementById("bgp-enabled").checked;if(h||n||t){if(e+=`routing-options {
`,h){e+=`    static {
...
`)}),e+=`    }
`}if(n){const t=document.getElementById("ospf-router-id").value;t&&(e+=`    router-id ${t};
`)}if(t){const t=document.getElementById("bgp-router-id").value;t&&(e+=`    router-id ${t};
`);const n=document.getElementById("bgp-local-as").value;n&&(e+=`    autonomous-system ${n};
`)}e+=`}

`}if(n||t){if(e+=`protocols {
`,n){e+=`    ospf {
...
`}const o=document.querySelectorAll(".filter-item");o.length>0&&(e+=`firewall {
`,o.forEach((t,n)=>{const s=t.querySelector(`#filter-name-${n}`).value,o=t.querySelector(`#filter-family-${n}`).value;if(s){e+=`    filter ${s} {
...
`,e+=`        }
`}}),e+=`    }
`;const o=t.querySelector(`#filter-interface-${n}`).value,i=t.querySelector(`#filter-direction-${n}`).value;o&&i&&(e+=`    interfaces {
`,e+=`        ${o} {
`,e+=`            filter {
`,e+=`                ${i} ${s};
`,e+=`            }
...
`);const v=document.getElementById("ntp-enabled");if(v&&v.checked){const t=document.getElementById("ntp-servers").value;t&&(e+=`system {
`,e+=`    ntp {
`,t.split(",").forEach(t=>{const n=t.trim();n&&(e+=`        server ${n};
`)}),e+=`    }
`,e+=`}

`)}const f=document.getElementById("dhcp-server-enabled");if(f&&f.checked){e+=`system {
`,e+=`    services {
`,e+=`        dhcp {
`;const t=document.querySelectorAll(".dhcp-pool");t.forEach((t,n)=>{const s=t.querySelector(`#dhcp-pool-name-${n}`).value,o=t.querySelector(`#dhcp-network-${n}`).value,i=t.querySelector(`#dhcp-range-${n}`).value,a=t.querySelector(`#dhcp-router-${n}`).value,r=t.querySelector(`#dhcp-dns-${n}`).value,c=t.querySelector(`#dhcp-lease-${n}`).value;s&&o&&i&&(e+=`            pool ${s} {
`,e+=`                subnet ${o};
`,e+=`                address-range ${i};
`,a&&(e+=`                router ${a};
`),r&&(e+=`                name-server ${r};
`),c&&(e+=`                maximum-lease-time ${c};
`),e+=`            }
`)}),e+=`        }
`,e+=`    }
`,e+=`}

`}const u=document.getElementById("syslog-enabled");if(u&&u.checked){const t=document.getElementById("syslog-server").value,n=document.getElementById("syslog-facility").value,s=document.getElementById("syslog-severity").value;t&&(e+=`system {
`,e+=`    syslog {
`,e+=`        host ${t} {
`,e+=`            facility ${n};
`,e+=`            level ${s};
...
`)}const d=document.getElementById("snmp-enabled");if(d&&d.checked){const t=document.getElementById("snmp-community").value,n=document.getElementById("snmp-location").value,s=document.getElementById("snmp-contact").value,o=document.getElementById("snmp-clients").value;t&&(e+=`system {
`,e+=`    snmp {
`,n&&(e+=`        location "${n}";
`),s&&(e+=`        contact "${s}";
`),e+=`        community ${t} {
`,o?o.split(",").forEach(t=>{const n=t.trim();n&&(e+=`            client-list ${n};
`)}):e+=`            authorization read-only;
`,e+=`        }
`,e+=`    }
`,e+=`}
...
`}y.textContent=e,document.getElementById("config-output-container").style.display="block"}let e=1;const D=document.getElementById("add-filter"),u=document.getElementById("filters-list");if(D&&u){D.addEventListener("click",()=>{const t=document.createElement("div");t.className="filter-item",t.innerHTML=`
                <div class="input-group">
            ...
            `,f.appendChild(e);const t=e.querySelector(".remove-zone");t&&t.addEventListener("click",function(){document.querySelectorAll(".zone-item").length>1?f.removeChild(e):alert("You need at least one security zone.")}),i++});const e=document.querySelector(".remove-zone");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".zone-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".zone-item");f.removeChild(e)}else alert("You need at least one security zone.")})}let o=1;const I=document.getElementById("add-policy"),h=document.getElementById("policies-list");if(I&&h){I.addEventListener("click",()=>{const e=document.createElement("div");e.className="policy-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,h.appendChild(e);const t=e.querySelector(".remove-policy");t&&t.addEventListener("click",function(){document.querySelectorAll(".policy-item").length>1?h.removeChild(e):alert("You need at least one security policy.")}),o++});const e=document.querySelector(".remove-policy");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".policy-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".policy-item");h.removeChild(e)}else alert("You need at least one security policy.")})}let r=1;const $=document.getElementById("add-prefix-list"),O=document.getElementById("prefix-lists");if($&&O){$.addEventListener("click",()=>{const e=document.createElement("div");e.className="prefix-list-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,O.appendChild(e);const n=e.querySelector(".add-prefix-entry"),t=e.querySelector(`#prefix-entries-${r}`);if(n&&t){let e=1;n.addEventListener("click",()=>{const n=document.createElement("div");n.className="prefix-entry",n.innerHTML=`
                    ...
                    <button class="remove-prefix-entry">Remove</button>
                `,e.appendChild(t);const s=t.querySelector(".remove-prefix-entry");s&&s.addEventListener("click",()=>{e.removeChild(t)}),n++})}const n=document.querySelector(".remove-prefix-list");n&&n.addEventListener("click",function(){if(document.querySelectorAll(".prefix-list-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".prefix-list-item");O.removeChild(e)}else alert("You need at least one prefix list.")})}let d=1;const K=document.getElementById("add-route-filter"),y=document.getElementById("route-filters");if(K&&y){K.addEventListener("click",()=>{const e=document.createElement("div");e.className="route-filter-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,g.appendChild(e)}else{const t=[...e].sort((e,t)=>{const n={error:0,warning:1,info:2};return n[e.severity]-n[t.severity]});t.forEach(e=>{const t=document.createElement("div");t.className=`validation-item ${e.severity}`;let n="";e.severity==="error"?n=`
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                `,g.appendChild(t),e.fix){const n=t.querySelector(".validation-fix");n&&n.addEventListener("click",()=>{e.fix()})}})}v.style.display="block"}function ae(){document.querySelectorAll(".interface-type-select").forEach(e=>{e.addEventListener("change",function(){const t=this.id.split("-").pop(),e=document.getElementById(`custom-interface-name-${t}`);this.value==="custom"?e.style.display="block":e.style.display="none"})})}ae();function re(){const n=document.getElementById("interfaces-list"),s=n.querySelectorAll(".interface-item"),e=s.length,t=document.createElement("div");t.className="interface-item",t.innerHTML=`
            <div class="interface-header">
                <div class="input-group">
        ...
        `,n.appendChild(t);const o=document.getElementById(`ipv6-enabled-${e}`);o.addEventListener("change",function(){const t=document.getElementById(`ipv6-config-${e}`);t.style.display=this.checked?"block":"none"});const i=document.getElementById(`interface-description-enabled-${e}`);i.addEventListener("change",function(){const t=document.getElementById(`description-group-${e}`);t.style.display=this.checked?"block":"none"});const a=document.getElementById(`vlan-enabled-${e}`);a.addEventListener("change",function(){const t=document.getElementById(`vlan-config-${e}`);t.style.display=this.checked?"block":"none"});const r=t.querySelector(".remove-interface");r.addEventListener("click",function(){document.querySelectorAll(".interface-item").length>1?n.removeChild(t):alert("You need at least one interface.")});const c=document.getElementById(`interface-type-${e}`);c.addEventListener("change",function(){const t=document.getElementById(`custom-interface-name-${e}`);t.style.display=this.value==="custom"?"block":"none"}),L()}let oe=document.getElementById("add-interface");oe&&oe.addEventListener("click",re);const se=document.getElementById("ipv6-enabled-0");se&&se.addEventListener("change",function(){const e=document.getElementById("ipv6-config-0");e.style.display=this.checked?"block":"none"});const G=document.getElementById("interface-description-enabled-0");G&&G.addEventListener("change",function(){const e=document.getElementById("description-group-0");e.style.display=this.checked?"block":"none"});const Y=document.getElementById("vlan-enabled-0");Y&&Y.addEventListener("change",function(){const e=document.getElementById("vlan-config-0");e.style.display=this.checked?"block":"none"});const S=document.getElementById("interface-type-0");S&&(S.classList.add("interface-type-select"),S.addEventListener("change",function(){const e=document.getElementById("custom-interface-name-0");e&&(e.style.display=this.value==="custom"?"block":"none")}));function L(){const e=[],t=document.querySelectorAll(".interface-item");t.forEach((t,n)=>{let s=t.querySelector(`#interface-type-${n}`).value;if(s==="custom"){const e=t.querySelector(`#custom-interface-value-${n}`).value;e?s=e:s="ge-0/0/0"}const i=t.querySelector(`#unit-number-${n}`).value||"0",o=`${s}.${i}`;e.push({name:o,value:o})});const n=document.querySelectorAll(".interface-select");n.forEach(t=>{const s=t.value;t.innerHTML="";const n=document.createElement("option");n.value="",n.textContent="-- Select Interface --",t.appendChild(n),e.forEach(e=>{const n=document.createElement("option");n.value=e.value,n.textContent=e.name,t.appendChild(n)}),s&&(t.value=s)})}})