...
`,r.textContent=e,document.getElementById("config-output-container").style.display="block"}let e=1;const z=document.getElementById("add-filter"),h=document.getElementById("filters-list");if(z&&h){z.addEventListener("click",()=>{const t=document.createElement("div");t.className="filter-item",t.innerHTML=`
                <div class="input-group">
