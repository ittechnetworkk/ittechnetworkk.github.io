...
`);t.textContent=s||"No headers found",t.className="result-box success"}catch{t.textContent="Error checking headers",t.className="result-box error"}}function setErrorState(){const n=["location","isp","country","region","city","timezone","coordinates","currency"],e=document.getElementById("ip-address");e&&(e.innerHTML=`
            <div class="ip-row">
