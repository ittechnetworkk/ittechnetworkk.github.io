document.addEventListener("DOMContentLoaded",()=>{const K=document.querySelectorAll(".tab-btn"),se=document.querySelectorAll(".tab-content");K.forEach(e=>{e.addEventListener("click",()=>{K.forEach(e=>e.classList.remove("active")),e.classList.add("active"),se.forEach(e=>e.style.display="none");const t=e.getAttribute("data-tab");document.getElementById(`${t}-content`).style.display="block"})});const oe=[{checkbox:"interface-description-enabled",section:"description-group"},{checkbox:"ipv6-enabled",section:"ipv6-config"},{checkbox:"vlan-enabled",section:"vlan-config"},{checkbox:"firewall-filter-enabled",section:"firewall-filter-config"},{checkbox:"zones-enabled",section:"zones-config"},{checkbox:"ntp-enabled",section:"ntp-config"},{checkbox:"ntp-source-interface-enabled",section:"ntp-source-interface-group"},{checkbox:"dhcp-server-enabled",section:"dhcp-server-config"},{checkbox:"syslog-enabled",section:"syslog-config"},{checkbox:"snmp-enabled",section:"snmp-config"},{checkbox:"policy-options-enabled",section:"policy-options-config"},{checkbox:"cos-enabled",section:"cos-config"},{checkbox:"routing-policy-prefix-list-enabled",section:"routing-policy-prefix-list-group"},{checkbox:"bgp-peer-import-policy-enabled",section:"bgp-peer-import-policy"},{checkbox:"bgp-peer-export-policy-enabled",section:"bgp-peer-export-policy"}];oe.forEach(e=>{const t=document.getElementById(e.checkbox+"-0");if(t){const n=document.getElementById(e.section+"-0");n&&t.addEventListener("change",()=>{n.style.display=t.checked?"block":"none"})}const n=document.getElementById(e.checkbox);if(n){const t=document.getElementById(e.section);t&&n.addEventListener("change",()=>{t.style.display=n.checked?"block":"none"})}});const E=document.getElementById("routing-protocol"),ae=document.querySelectorAll(".protocol-config");E&&E.addEventListener("change",()=>{ae.forEach(e=>{e.style.display="none"});const e=E.value;e!=="none"&&(document.getElementById(`${e}-config`).style.display="block")});const y=document.getElementById("term-protocol-0"),k=document.getElementById("port-fields-0");y&&k&&y.addEventListener("change",()=>{y.value==="tcp"||y.value==="udp"?k.style.display="block":k.style.display="none"});let t=1;const z=document.getElementById("add-interface"),g=document.getElementById("interfaces-list");if(z&&g){z.addEventListener("click",()=>{const e=document.createElement("div");e.className="interface-item",e.innerHTML=`
            ...
            `,g.appendChild(e);const n=document.getElementById(`ipv6-enabled-${t}`);n.addEventListener("change",function(){const e=document.getElementById(`ipv6-config-${t}`);e.style.display=this.checked?"block":"none"});const s=document.getElementById(`interface-description-enabled-${t}`);s.addEventListener("change",function(){const e=document.getElementById(`description-group-${t}`);e.style.display=this.checked?"block":"none"});const o=document.getElementById(`vlan-enabled-${t}`);o.addEventListener("change",function(){const e=document.getElementById(`vlan-config-${t}`);e.style.display=this.checked?"block":"none"});const i=e.querySelector(".remove-interface");i.addEventListener("click",function(){document.querySelectorAll(".interface-item").length>1?g.removeChild(e):alert("You need at least one interface.")});const a=document.getElementById(`interface-type-${t}`);a.addEventListener("change",function(){const e=document.getElementById(`custom-interface-name-${t}`);e.style.display=this.value==="custom"?"block":"none"}),N(),t++});const e=document.querySelector(".remove-interface");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".interface-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".interface-item");g.removeChild(e)}else alert("You need at least one interface.")})}let c=1;const L=document.getElementById("add-static-route"),h=document.getElementById("static-routes-list");if(L&&h){L.addEventListener("click",()=>{const e=document.createElement("div");e.className="static-route-item",e.innerHTML=`
                <div class="input-group">
...
`}b.textContent=e,document.getElementById("config-output-container").style.display="block"}let e=1;const T=document.getElementById("add-filter"),u=document.getElementById("filters-list");if(T&&u){T.addEventListener("click",()=>{const t=document.createElement("div");t.className="filter-item",t.innerHTML=`
                <div class="input-group">
            ...
            `,m.appendChild(e);const t=e.querySelector(".remove-zone");t&&t.addEventListener("click",function(){document.querySelectorAll(".zone-item").length>1?m.removeChild(e):alert("You need at least one security zone.")}),i++});const e=document.querySelector(".remove-zone");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".zone-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".zone-item");m.removeChild(e)}else alert("You need at least one security zone.")})}let o=1;const D=document.getElementById("add-policy"),w=document.getElementById("policies-list");if(D&&w){D.addEventListener("click",()=>{const e=document.createElement("div");e.className="policy-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,w.appendChild(e);const t=e.querySelector(".remove-policy");t&&t.addEventListener("click",function(){document.querySelectorAll(".policy-item").length>1?w.removeChild(e):alert("You need at least one security policy.")}),o++});const e=document.querySelector(".remove-policy");e&&e.addEventListener("click",function(){if(document.querySelectorAll(".policy-item").length>1){const t=this.getAttribute("data-id"),e=this.closest(".policy-item");w.removeChild(e)}else alert("You need at least one security policy.")})}let r=1;const S=document.getElementById("add-prefix-list"),O=document.getElementById("prefix-lists");if(S&&O){S.addEventListener("click",()=>{const e=document.createElement("div");e.className="prefix-list-item",e.innerHTML=`
                <div class="input-group">
            ...
            `,f.appendChild(e)}else{const t=[...e].sort((e,t)=>{const n={error:0,warning:1,info:2};return n[e.severity]-n[t.severity]});t.forEach(e=>{const t=document.createElement("div");t.className=`validation-item ${e.severity}`;let n="";e.severity==="error"?n=`
                ...
                `,f.appendChild(t),e.fix){const n=t.querySelector(".validation-fix");n&&n.addEventListener("click",()=>{e.fix()})}})}v.style.display="block"}function ee(){document.querySelectorAll(".interface-type-select").forEach(e=>{e.addEventListener("change",function(){const t=this.id.split("-").pop(),e=document.getElementById(`custom-interface-name-${t}`);this.value==="custom"?e.style.display="block":e.style.display="none"})})}ee();function te(){const n=document.getElementById("interfaces-list"),s=n.querySelectorAll(".interface-item"),e=s.length,t=document.createElement("div");t.className="interface-item",t.innerHTML=`
            <div class="interface-header">
                <div class="input-group">
        ...
        `,n.appendChild(t);const o=document.getElementById(`ipv6-enabled-${e}`);o.addEventListener("change",function(){const t=document.getElementById(`ipv6-config-${e}`);t.style.display=this.checked?"block":"none"});const i=document.getElementById(`interface-description-enabled-${e}`);i.addEventListener("change",function(){const t=document.getElementById(`description-group-${e}`);t.style.display=this.checked?"block":"none"});const a=document.getElementById(`vlan-enabled-${e}`);a.addEventListener("change",function(){const t=document.getElementById(`vlan-config-${e}`);t.style.display=this.checked?"block":"none"});const r=t.querySelector(".remove-interface");r.addEventListener("click",function(){document.querySelectorAll(".interface-item").length>1?n.removeChild(t):alert("You need at least one interface.")});const c=document.getElementById(`interface-type-${e}`);c.addEventListener("change",function(){const t=document.getElementById(`custom-interface-name-${e}`);t.style.display=this.value==="custom"?"block":"none"}),N()}let Z=document.getElementById("add-interface");Z&&Z.addEventListener("click",te);const Q=document.getElementById("ipv6-enabled-0");Q&&Q.addEventListener("change",function(){const e=document.getElementById("ipv6-config-0");e.style.display=this.checked?"block":"none"});const V=document.getElementById("interface-description-enabled-0");V&&V.addEventListener("change",function(){const e=document.getElementById("description-group-0");e.style.display=this.checked?"block":"none"});const R=document.getElementById("vlan-enabled-0");R&&R.addEventListener("change",function(){const e=document.getElementById("vlan-config-0");e.style.display=this.checked?"block":"none"});const A=document.getElementById("interface-type-0");A&&(A.classList.add("interface-type-select"),A.addEventListener("change",function(){const e=document.getElementById("custom-interface-name-0");e&&(e.style.display=this.value==="custom"?"block":"none")}));function N(){const e=[],t=document.querySelectorAll(".interface-item");t.forEach((t,n)=>{let s=t.querySelector(`#interface-type-${n}`).value;if(s==="custom"){const e=t.querySelector(`#custom-interface-value-${n}`).value;e?s=e:s="ge-0/0/0"}const i=t.querySelector(`#unit-number-${n}`).value||"0",o=`${s}.${i}`;e.push({name:o,value:o})});const n=document.querySelectorAll(".interface-select");n.forEach(t=>{const s=t.value;t.innerHTML="";const n=document.createElement("option");n.value="",n.textContent="-- Select Interface --",t.appendChild(n),e.forEach(e=>{const n=document.createElement("option");n.value=e.value,n.textContent=e.name,t.appendChild(n)}),s&&(t.value=s)})}})