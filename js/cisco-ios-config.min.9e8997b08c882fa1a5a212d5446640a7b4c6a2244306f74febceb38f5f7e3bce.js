document.addEventListener("DOMContentLoaded",()=>{const v=document.querySelectorAll(".tab-btn"),E=document.querySelectorAll(".tab-content");v.forEach(e=>{e.addEventListener("click",()=>{v.forEach(e=>e.classList.remove("active")),e.classList.add("active"),E.forEach(e=>e.style.display="none");const t=e.getAttribute("data-tab");document.getElementById(`${t}-content`).style.display="block"})});const u=document.getElementById("ssh-enabled"),R=document.getElementById("ssh-config");u.addEventListener("change",()=>{R.style.display=u.checked?"block":"none"});const y=document.getElementById("acl-enabled"),N=document.getElementById("acl-config");y.addEventListener("change",()=>{N.style.display=y.checked?"block":"none"});const l=document.getElementById("ntp-enabled"),z=document.getElementById("ntp-config");l.addEventListener("change",()=>{z.style.display=l.checked?"block":"none"});const f=document.getElementById("dhcp-enabled"),x=document.getElementById("dhcp-config");f.addEventListener("change",()=>{x.style.display=f.checked?"block":"none"});const d=document.getElementById("syslog-enabled"),_=document.getElementById("syslog-config");d.addEventListener("change",()=>{_.style.display=d.checked?"block":"none"}),document.getElementById("interface-description-enabled-0").addEventListener("change",function(){document.getElementById("description-group-0").style.display=this.checked?"block":"none"});const o=document.getElementById("acl-type"),M=document.querySelectorAll(".extended-acl-fields");o.addEventListener("change",()=>{const e=o.value==="extended";M.forEach(t=>{t.style.display=e?"block":"none"})});const c=document.getElementById("acl-protocol-0"),S=document.querySelectorAll(".port-fields");c.addEventListener("change",()=>{const e=c.value==="tcp"||c.value==="udp";S.forEach(t=>{t.style.display=e?"block":"none"})});const r=document.getElementById("routing-protocol"),k=document.querySelectorAll(".protocol-config");r.addEventListener("change",()=>{k.forEach(e=>{e.style.display="none"});const e=r.value;e!=="none"&&(document.getElementById(`${e}-config`).style.display="block")}),r.value==="static"&&(document.getElementById("static-routes-config").style.display="block");let e=1;const T=document.getElementById("add-interface"),i=document.getElementById("interfaces-list");T.addEventListener("click",()=>{const t=document.createElement("div");t.className="interface-item",t.innerHTML=`
        ...
        `,a.appendChild(e);const t=e.querySelector(".remove-route");t.addEventListener("click",()=>{a.removeChild(e)}),s++});let n=1;const C=document.getElementById("add-acl-entry"),b=document.getElementById("acl-entries");C.addEventListener("click",()=>{const e=document.createElement("div");e.className="acl-entry",e.innerHTML=`
            <div class="input-group">
        ...
        `,b.appendChild(e);const t=e.querySelector(`#acl-protocol-${n}`),s=e.querySelector(".port-fields");t.addEventListener("change",()=>{const e=t.value==="tcp"||t.value==="udp";s.style.display=e?"block":"none"});const i=e.querySelector(".remove-acl-entry");i.addEventListener("click",()=>{b.removeChild(e)}),n++});let t=1;const A=document.getElementById("add-dhcp-pool"),p=document.getElementById("dhcp-pools");A.addEventListener("click",()=>{const e=document.createElement("div");e.className="dhcp-pool",e.innerHTML=`
            <div class="input-group">
