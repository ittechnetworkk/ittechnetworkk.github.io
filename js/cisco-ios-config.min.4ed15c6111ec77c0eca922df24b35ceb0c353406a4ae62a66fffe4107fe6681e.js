...
`),s&&o&&(e+=`
! SSH key generation - run this command first
`,e+=`! This will prompt you for key size - enter 2048 for best security
...
! SSH configuration
`,o||(e+=`! Generate RSA keys for SSH (run this command first)
`,e+=`crypto key generate rsa modulus 2048
